...
namespace API_TUBES_KPL_KELOMPOK_05.Controllers
{
    ...
    public class BukuController : Controller
    {
        ...
        {
            string jsonFilePath = "D:\\InvenBarang_KPL\\API_Barang\\Data\\DataBarang.json";
        ...
        [HttpGet("{NamaBarang}")]
        public ActionResult<Barang> GET(string Judul)
        {
            try
            {
                int id = -1;
                ...
                {
                    if (Judul == DataDisplayBarang[i].NamaBarang)
                    {
                        id = i;
                    }
                }
